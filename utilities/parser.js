...
lexer.reset("TIER* DE 12-842578     BERLIN        DE").next()?.type;
...
const runThroughParser = (string) => lexer.reset(string.trim()).next()?.type;
console.log(JSON.stringify(testStrings.map(runThroughParser), null, 4));
